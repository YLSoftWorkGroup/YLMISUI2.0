                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'isTree', label: '树', width:80,  scopedSlot: 'isTree',   } },   
                                {attr: { prop: 'isLeaf', label: '子节点', width:80, scopedSlot: 'isLeaf',    } }, 
                                 {attr: { prop: 'sortCode', label: '排序', width:55,align: 'center',headerAlign:'center'} },    
