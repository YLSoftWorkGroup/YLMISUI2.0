                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'moduleType', label: '类型', width:50,  } },   
                                {attr: { prop: 'muduleName', label: '模块名称', width:120,  } },   
                                {attr: { prop: 'stateValue', label: '审批状态值', width:90,scopedSlot: 'stateValue',  } },   
                                {attr: { prop: 'boolValue', label: '流程方向', width:80, scopedSlot: 'boolValue', } },   
                                {attr: { prop: 'stateText', label: '状态文本值', width:100,  } },   
                                {attr: { prop: 'isState', label: '是否为初始值', width:100,  } },   
