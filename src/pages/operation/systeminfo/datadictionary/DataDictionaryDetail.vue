                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'isStatic', label: '系统参数',  width:70, scopedSlot: 'isStatic',   } }, 
                                {attr: { prop: 'isLeaf', label: '子节点',  width:70, scopedSlot: 'isLeaf',   } }, 
                                {attr: { prop: 'isTree', label: '树',  width:70, scopedSlot: 'isTree',   } },  
                                {attr: { prop: 'sortCode', label: '排序',width:60,width:60,align: 'center',headerAlign:"center"    } }, 
