        ...
        <yl-layout class="gbpt">
            ...
            <div slot="secondbox" class="flexbox">
                ...
                <el-dialog ref="cameraEdit" :title="'拍照信息'" v-model="openCameraEdit" size="normal"  top="35%" 
                            ...
                            <cameraEidt  type="pt" :orderModel="selectRows[0]"  v-if="openCameraEdit"></cameraEidt>
                </el-dialog>
            </div>
        </yl-layout>
</template>
...
export default {
  ...
  computed: {
            isCarNumAutoRead:{
                get(){
                     let carNumRecognite=this.gbGlobConf.commonConf.ptConf.carNumRecognite;
                     if(carNumRecognite){
            ...
            isCameraEditShow:{
                get(){
                     let speedCamera=this.gbGlobConf.commonConf.ptConf.speedCamera;
                     if(speedCamera){
   ...
   methods:{
       ...
       _openCameraEdit(){
        ...
        async _printPage(params1,type){
                ...
                if(type==0){
                    //不带扣重
                   printModelID=_this.gbGlobConf.commonConf.ptConf.print.nonkzTemplate.id;
                }else if(type==1){
                    //代扣重
                    printModelID=_this.gbGlobConf.commonConf.ptConf.print.kzTemplate.id;
                }else if(type==2){
                    //电子磅单
                    printModelID=_this.gbGlobConf.commonConf.ptConf.print.imgTemplate.id;
                }
        ...
        _currentChange(val){
                    if(val){
                        ...
                        console.log(this.formModel.order)
                    ...
                    let  result= await  this.asyncFunc({
                                                ...
                                                data:{
                                                    queryConditionItem:[
                                                                        ...
                                                                        {dataField:"V_Col24",op:'EQ',dataValue:'进料过磅'},
        ...
        async  _importWight(){
            ...
            _this.formModel.order.v_Col24='进料过磅';
            ...
            //保存数据
             ...
             if(result===null){
                ...
                if(_this.gbGlobConf.commonConf!=undefined){
                    if(_this.gbGlobConf.commonConf.ptConf.upload.realTime){
                           //先获去数据
                ...
                if(_this.gbGlobConf.commonConf===undefined){
                    ...
                    if(_this.gbGlobConf.commonConf.ptConf.print.isPrint){
                        //打印提示
                        if(_this.gbGlobConf.commonConf.ptConf.print.isPrintView){
                            //预览
                               _this._printPage(_this.formModel.order,_this.gbGlobConf.commonConf.ptConf.print.type);
        ...
        async _materialChange(node){
            ...
            if(node[0]!=undefined){
                ...
                this.formModel.order.d_Col44=Obj[0].sD_Col10;
                //根据材料信息加载料仓
