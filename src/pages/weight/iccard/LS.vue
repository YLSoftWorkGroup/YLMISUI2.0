    ...
    <div slot="content" style="background-color:white">
        <el-form  :model="formModel"  :rules="rules"  ref="formModel" label-width="90px" style="height:450px;padding:15px 1.5em 3ex 1%;">
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="委托单位" prop="v_Col6">
     ...
     methods:{
        ...
        _materialchange(id){
             if(id != undefined&id!=""){
                ...
                //材料
                this.formModel.order.i_Col1=d[0].oriBigId;
                this.formModel.order.v_Col31=d[0].oriStrId;
                this.formModel.order.v_Col38=d[0].sV_Col5;
                //类别
                this.formModel.order.i_Col2=d[0].oriBigClassId;
                this.formModel.order.v_Col32=d[0].oriStrClassId;
